[README.md](https://github.com/user-attachments/files/26856612/README.md)
# 📦 박스권 스캐너 컨트롤룸

코스피 + 코스닥 시가총액 상위 종목을 자동으로 스캔해서
