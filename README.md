[README.md](https://github.com/user-attachments/files/28436744/README.md)
# 박스권 스캐너 컨트롤룸
...
| API | 만료일 | 비고 |
| --- | --- | --- |
| 유가증권 일별매매정보 | 2026/06/03 | 재신청 승인대기 중 |
| 코스닥 종목기본정보 | 2026/06/05 | 재신청 승인대기 중 |
| ETF 일별매매정보 | 2026/06/06 | 재신청 승인대기 중 |
| 코스닥 일별매매정보 | 2026/06/06 | 재신청 승인대기 중 |
| ETN 일별매매정보 | 2026/06/06 | 재신청 승인대기 중 |
| 유가증권 종목기본정보 | 2026/06/06 | 재신청 승인대기 중 |
| 코넥스 일별매매정보 | 2026/06/06 | 재신청 승인대기 중 |
| 코넥스 종목기본정보 | 2026/06/06 | 재신청 승인대기 중 |

- API 키 자체는 내년까지 유효 — 별도 갱신 불필요
- 개별 API 승인기간은 만료 전 KRX 마이페이지에서 재신청
